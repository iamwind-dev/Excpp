...
int main()
{
    ...
    insert(hashtable, SIZE, 6);
    insert(hashtable, SIZE, 12);
    insert(hashtable, SIZE, 34);
    insert(hashtable, SIZE, 29);
    insert(hashtable, SIZE, 28);
    insert(hashtable, SIZE, 11);
    insert(hashtable, SIZE, 23);
    insert(hashtable, SIZE, 7);
    insert(hashtable, SIZE, 0);
    insert(hashtable, SIZE, 33);
    insert(hashtable, SIZE, 30);
    insert(hashtable, SIZE, 45);
